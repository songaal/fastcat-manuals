...
URL : `POST /service/recommendation/item`
...
URL : `POST /service/recommendation/user`


5. 그룹기반 인기상품 추천 API

앞서본 4장의 아이템 추천이 개인에 대한 추천이라고 한다면, 그룹기반은 개인이 속한 그룹에 대하여 아이템을 추천해주는 방식이다. 또한 아이템 추천은 협업필터 방식인데 반해 이 그룹기반 추천은 해당 그룹에서 가장 인기가 많은 아이템을 추천해주는 인기도 정렬 방식이다. 
...
URL : `GET /service/recommendation/groupItem`